" or use
" https://github.com/Shougo/defx.nvim/blob/master/doc/defx.txt#L664
" nmap <silent> <leader>dx :Defx<CR>
...
nnoremap <silent><Leader>dfr :call <sid>defx_open()<CR>
nnoremap <silent><Leader>df :call <sid>defx_open({ 'find_current_file': v:true })<CR>
...
function! s:defx_open(...) abort
  ...
  let l:args = '-winwidth=35 -direction=topleft -split=vertical'
